...
```{r echo = FALSE, fig.width = 10.1, fig.height = 5.7, dpi = 600}
pre.species <- fviz_pca_ind(pca.pre,
                            ...
                            repel = TRUE,
                            label = "none",
                            title = "Figure C.5a: Pre-Construction Species Groupings") + theme(plot.title = element_text(size=12), title = element_text(face = "italic"))
...
post.species <- fviz_pca_ind(pca.post,
                            ...
                            repel = TRUE,
                            label = "none",
                            title = "Figure C.5b: Post-Construction Species Groupings") + theme(plot.title = element_text(size=12), title = element_text(face = "italic"))
...
When overlaid with recent traffic data onto our historical data, we can see some relationship with the presence of traffic.Only post-construction data can be examined here due to the lack of a constructed roadway in pre-construction settings. In post-construction, it's observed that coyotes have a preference for traffic while every other species does not seem affected. This could present an issue with coyote's natural hunting patterns as traffic is presenting as a barrier to prey access.
...
```{r echo = FALSE,fig.width = 10.1, fig.height = 7, dpi = 600}
